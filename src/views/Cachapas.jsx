...
import cachapa1 from '../img/Cachapa_1.png';
            ...
            <div className={styles.menu}>
                ...
                <div className={styles.catalogo}>
                    ...
                    <div className={styles.cartamenu}>
                        <NavLink to="/Cachapas">
                            <h1 className={styles.titulocarta}>Cachapa con Queso Telita</h1>
                            <img src={cachapa} alt="cachapa" />
                        </NavLink>
                       
                    </div>
                    <div className={styles.cartamenu}>
                        <NavLink to={routes[1]["children"][1].path}>
                        <h1 className={styles.titulocarta}>Cachapa con Queso Guayanes</h1>  
                        <img src={cachapa1} alt="cachapa1" />
                        </NavLink>
                    </div>
