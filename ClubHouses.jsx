        ...
        <div className={styles.pageContainer}>
            <div className={styles.botonesMenu}>
                ...
                <div className={styles.botonMenuC}>
                    <h1 className={styles.tituloboton}> <span className={styles.colored}>Club Houses</span></h1>                                                     
            ...
            <div className={styles.categoria}>
                ...
                <h1 className={styles.titulo_categoria}>Club Houses</h1>
